...
public static class ModCompatibility
{
    ...
    public static void InitSubmerged()
    {
        ...
        SubLoaded = true;
        Logger<OWPlugin>.Message("Submerged was detected");
    }
    ...
    public static IEnumerable<CodeInstruction> SubmergedElevatorTranspilerPatch(IEnumerable<CodeInstruction> instructions)
    {
        ...
        if (!found)
        {
            Logger<OWPlugin>.Error("Failed to find the IsDead call in SubmergedElevator transpiler");
        }
    }
    ...
    private static void InitLevelImpostor()
    {
        ...
        LILoaded = true;
        Logger<OWPlugin>.Message("LevelImpostor was detected");
    }
