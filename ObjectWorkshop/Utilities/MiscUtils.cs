...
public static class MiscUtils
{
    ...
    public static int NKillersAliveCount => 0;// Helpers.GetAlivePlayers().Count(x =>
        //x.Is(Faction.Coven) || x.Is(Faction.Infiltrator) || x.Is(Faction.SerialKiller) || x.Is(Faction.Apocalypse));
    ...
    public static Alignment GetRoleAlignment(this RoleBehaviour role)
    {
        ...
        {
            return Alignment.InfiltratorUtility;
        }
        else
        {
    ...
    public static IEnumerable<RoleBehaviour> GetPotentialRoles()
    {
        ...
        //Logger<OWPlugin>.Error($"GetPotentialRoles - crewmateRole: '{crewmateRole?.NiceName}'");
        ...
        //Logger<OWPlugin>.Error($"GetPotentialRoles - impostorRole: '{impostorRole?.NiceName}'");

        //roleList.Do(x => Logger<OWPlugin>.Error($"GetPotentialRoles - role: '{x.NiceName}'"));
