...
public static class PlayerJoinPatch
{
    ...
    private static IEnumerator CoSendJoinMsg()
    {
        ...
        Logger<OWPlugin>.Info("Client Initialized?");
        ...
        Logger<OWPlugin>.Info("Sending Message to Local Player...");
        ...
        Logger<OWPlugin>.Info("Offset Wiki Button (if needed)");
        SentOnce = true;
    }
}