...
#pragma warning restore S1075 // URIs should not be hardcoded
    ...
    public static IEnumerator FetchNews()
    {
        ...
        downloaded = true;
        if (OWPlugin.IsDevBuild)
        {
            Logger<OWPlugin>.Error($"Loading News Locally, as this is a DEVELOPER BUILD");
        ...
        {
            downloaded = false;
            Logger<OWPlugin>.Error($"Couldn't fetch mod news from github: {request.error}");
            LoadTouMiraModNewsFromResources();
            yield break;
        }
    ...
    public static class ModNewsHistory
    {
        ...
        public static void SetModAnnouncements_Prefix(ref Il2CppReferenceArray<Announcement> aRange)
        {
            ...
            {
                Logger<OWPlugin>.Error($"No mod news were found.");
                return;
            }
