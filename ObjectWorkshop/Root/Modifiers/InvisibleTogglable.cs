...
public sealed class InvisibleTogglable : BaseModifier, IVisualAppearance
{
    public override string ModifierName => "Invisible Toggle";
    ...
    public VisualAppearance GetVisualAppearance()
    {
        ...
        return new VisualAppearance(Player.GetDefaultModifiedAppearance(), OWAppearances.Invisible)
        {
            HatId = string.Empty,
            SkinId = string.Empty,
