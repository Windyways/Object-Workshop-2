...
public static class DeathStateSync
{
    ...
    /// </summary>
    [MethodRpc((uint)Rpcs.SyncDeathState, LocalHandling = RpcLocalHandling.Before)]
    ...
    /// </summary>
    [MethodRpc((uint)Rpcs.RequestDeathStateValidation, LocalHandling = RpcLocalHandling.Before)]
