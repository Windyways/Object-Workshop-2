...
public static class Keyboard_Joystick
{
    ...
    public static void Postfix()
    {
        ...
        else if (Input.GetKeyDown(KeyCode.F6)) OWPlugin.Persistence = !OWPlugin.Persistence;
    ...
    internal static void CreatePlayer()
    {
        ...
        if (PlayerControl.AllPlayerControls.Count == 25 && !Input.GetKeyDown(KeyCode.Keypad9)) return; 
